...
angular.module("app",["file","player","templates-main","ngRoute"]).config(["$locationProvider","$routeProvider",function(b,e){b.html5Mode(!1);b.hashPrefix("");e.when("/",{template:""}).when("/remote",{template:""}).otherwise({redirectTo:"/"})}]);

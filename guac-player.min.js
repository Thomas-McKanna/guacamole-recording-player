angular.module("app").controller("appController",["$scope","urlParamService","remoteFileService",function(b,e,a){b.selectedRecording=null;b.playing=!1;b.error=!1;b.errorMessage=null;b.remoteMode=!1;b.downloading=!1;b.$on("guacPlayerLoading",function(){b.error=!1;b.errorMessage=null});b.$on("guacPlayerError",function(a,c){b.selectedRecording=null;b.error=!0;b.errorMessage=c||"An error occurred while loading the recording."});b.$on("guacPlayerPlay",function(){b.playing=!0});b.$on("guacPlayerPause",
function(){b.playing=!1});(function(){if(e.isPath("/guacamole-recording-player/remote")){b.remoteMode=!0;var k=e.getParam("url");k?(b.downloading=!0,a.downloadFile(k).then(function(a){b.selectedRecording=a;b.downloading=!1}).catch(function(a){b.error=!0;b.errorMessage=a;b.downloading=!1;console.error("Remote file download error:",a)})):(b.error=!0,b.errorMessage="No URL specified. Use /remote?url\x3d\x3curl\x3e to specify a remote recording.")}else b.remoteMode=!1})()}]);
angular.module("app",["file","player","templates-main","ngRoute"]).config(["$locationProvider","$routeProvider",function(b,e){b.html5Mode(!0);e.when("/guacamole-recording-player/",{template:""}).when("/guacamole-recording-player/remote",{template:""}).otherwise({redirectTo:"/guacamole-recording-player/"})}]);
angular.module("file").directive("guacFileChooser",[function(){return{restrict:"E",templateUrl:"modules/file/templates/fileChooser.html",transclude:!0,scope:{file:"\x3d"},controller:["$scope","$element",function(b,e){e.find('input[type\x3d"file"]').on("change",function(){var a=this.files;1===a.length&&b.$apply(function(){b.file=a[0]})})}]}}]);angular.module("file",["templates-main"]);
angular.module("player").directive("guacPlayer",["$injector",function(b){var e=b.get("SessionRecording");return{restrict:"E",templateUrl:"modules/player/templates/player.html",scope:{blob:"\x3d"},controller:["$scope","$element","$injector",function(a){a.recording=null;a.playbackPosition=0;a.operationText=null;a.operationProgress=0;a.seekPosition=null;var b=!1,c=!1;a.formatTime=function(a){a=Math.floor((a||0)/1E3);for(var b=[1,24,60,60],c=b.length-1;0<=c;c--){var d=b[c],e=a%d;b[c]=9<e?e:"0"+e;a=Math.floor(a/
...
null;a.$evalAsync()}));b=!1};a.togglePlayback=function(){a.recording&&(a.recording.isPlaying()?a.recording.pause():a.recording.play())};a.$watch("blob",function(c){b=!1;a.playbackPosition=0;a.recording&&(a.recording.pause(),a.recording.abort());c?(a.recording=new e(c),a.recording.onload=function(){a.operationText=null;a.$emit("guacPlayerLoaded");a.$evalAsync()},a.recording.onerror=function(b){a.operationText=null;a.$emit("guacPlayerError",b);a.$evalAsync()},a.recording.onprogress=function(b,d){a.operationProgress=
d/c.size;a.$emit("guacPlayerProgress",b,d);a.$evalAsync()},a.recording.onplay=function(){a.$emit("guacPlayerPlay");a.$evalAsync()},a.recording.onpause=function(){a.$emit("guacPlayerPause");a.$evalAsync()},a.recording.onseek=function(b,c,d){a.recording.isPlaying()?a.playbackPosition=b:(a.seekPosition=b,a.operationProgress=c/d);a.$emit("guacPlayerSeek",b);a.$evalAsync()},a.operationText="Your recording is now being loaded. Please wait...",a.operationProgress=0,a.cancelOperation=function(){a.recording.abort();
a.operationText=null},a.$emit("guacPlayerLoading")):a.recording=null})}]}}]);
angular.module("player").directive("guacPlayerDisplay",[function(){return{restrict:"E",templateUrl:"modules/player/templates/playerDisplay.html",scope:{display:"\x3d"},controller:["$scope","$element",function(b,e){var a=e[0],k=e.find(".guac-player-display-container")[0],c=e.find(".guac-resize-sensor")[0],d=function(){if(b.display){var c=b.display.getWidth(),d=b.display.getHeight();c&&d&&b.display.scale(Math.min(a.offsetWidth/c,a.offsetHeight/d))}};b.$watch("display",function(a,b){b&&(k.innerHTML=

...
angular.module("app",["file","player","templates-main","ngRoute"]).config(["$locationProvider","$routeProvider",function(b,e){b.html5Mode(!0);e.when("/",{template:""}).when("/guacamole-recording-player/remote",{template:""}).otherwise({redirectTo:"/"})}]);
